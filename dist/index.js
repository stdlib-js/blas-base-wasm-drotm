"use strict";var l=function(e,r){return function(){try{return r||e((r={exports:{}}).exports,r),r.exports}catch(i){throw (r=0, i)}};};var M=l(function(Q,E){
...
var g=require('@stdlib/assert-is-wasm-memory/dist'),_=require('@stdlib/utils-define-nonenumerable-read-only-property/dist'),j=require('@stdlib/utils-inherit/dist'),R=require('@stdlib/wasm-module-wrapper/dist'),z=require('@stdlib/error-tools-fmtprodmsg/dist'),D=M();function v(e){if(!(this instanceof v))return new v(e);if(!g(e))throw new TypeError(z('26hH0',e));return R.call(this,D,e,{env:{memory:e}}),this}j(v,R);_(v.prototype,"main",function(r,i,a,n,t,s){return this._instance.exports.c_drotm(r,i,a,n,t,s),n});_(v.prototype,"ndarray",function(r,i,a,n,t,s,p,q){return this._instance.exports.c_drotm_ndarray(r,i,a,n,t,s,p,q),t});b.exports=v
});var A=l(function(Z,W){
var S=require('@stdlib/utils-define-nonenumerable-read-only-property/dist'),k=require('@stdlib/utils-inherit/dist'),x=require('@stdlib/strided-base-stride2offset/dist'),T=require('@stdlib/strided-base-read-dataview/dist').ndarray,C=require('@stdlib/wasm-memory/dist'),F=require('@stdlib/wasm-base-arrays2ptrs/dist'),m=require('@stdlib/wasm-base-strided2object/dist'),f=y();function d(){return this instanceof d?(f.call(this,new C({initial:0})),this):new d}k(d,f);S(d.prototype,"main",function(r,i,a,n,t,s){return this.ndarray(r,i,a,x(r,a),n,t,x(r,t),s)});S(d.prototype,"ndarray",function(r,i,a,n,t,s,p,q){var c,u,o,w;return c=F(this,[m(r,i,a,n),m(r,t,s,p),m(5,q,1,0)]),u=c[0],o=c[1],w=c[2],f.prototype.ndarray.call(this,r,u.ptr,u.stride,u.offset,o.ptr,o.stride,o.offset,w.ptr),u.copy&&T(r,this.view,u.stride*u.BYTES_PER_ELEMENT,u.ptr,i,a,n,!0),o.copy&&T(r,this.view,o.stride*o.BYTES_PER_ELEMENT,o.ptr,t,s,p,!0),t});W.exports=d
});var O=l(function($,B){
