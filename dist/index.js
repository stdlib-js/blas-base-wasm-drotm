...
var j=require('@stdlib/assert-is-wasm-memory/dist'),M=require('@stdlib/utils-define-nonenumerable-read-only-property/dist'),z=require('@stdlib/utils-inherit/dist'),_=require('@stdlib/wasm-module-wrapper/dist'),D=require('@stdlib/error-tools-fmtprodmsg/dist'),k=E();function v(e){if(!(this instanceof v))return new v(e);if(!j(e))throw new TypeError(D('26hH0',e));return _.call(this,k,e,{env:{memory:e}}),this}z(v,_);M(v.prototype,"main",function(r,n,i,a,t,s){return this._instance.exports.c_drotm(r,n,i,a,t,s),a});M(v.prototype,"ndarray",function(r,n,i,a,t,s,p,q){return this._instance.exports.c_drotm_ndarray(r,n,i,a,t,s,p,q),t});R.exports=v
